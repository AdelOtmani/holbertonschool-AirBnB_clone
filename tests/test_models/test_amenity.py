#!/usr/bin/python3
"""Unittests for base model class amenity"""
...
class TestsAmenity(unittest.TestCase):
    ...
    def test_normal_cases_amenity(self):
        """use cases"""
        my_object = Amenity()
        my_object.name = "Holberton"
        my_object.my_number = 12
        my_object.save()
        my_object_dict = my_object.to_dict()
        self.assertEqual(my_object.name, "Holberton")
        self.assertEqual(my_object.my_number, 12)
